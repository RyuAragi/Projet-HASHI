/**
 * Copied from https://js.live.net/v7.2/OneDrive.js, formatted with prettier
 *
 * Changed the logic in the following ways:
 * - Sets API object to always set it to window.OneDrive (see commented out
 *   block on line 37). Did this because we don't support the signature of the
 ...
 *   the best solution is to consistently set it in one way
 *   (i.e. window.OneDrive).
 *
 * - replaces an assignment to the function parameter with `this` in the
 *   es6-promise polyfill. After inspecting the un-minified source for v3.3.1 of
 *   the promise polyfill, the parameter got mangled incorrectly somehow when
 *   Microsoft minified their bundle. The provided code works fine, even in
            ...
            var r = new RegExp(
              ...
              i = (function() {
                function i(e) {
                  ...
                  this.redirectUri =
                    this.redirectUri || f.trimUrlQuery(window.location.href);
                ...
                i.checkClientId = function(e) {
                  e
                    ? r.test(e)
                      ? o.default.logMessage("parsed client id: " + e)
                      : u.throwError(
                          new d.default(
                            l.default.unknown,
                            c.format(
                  ...
                  if (e.advanced) {
                    ...
                    if (e.advanced.queryParameters) {
                      ...
                      var i = t.select,
                        n = t.expand;
                      i && n
                        ? (this.queryParameters = c.format(
                            "expand={0}&select={1}",
                            n,
                            i
                          ))
                        : n
                        ? (this.queryParameters = c.format("expand={0}", n))
                        : i &&
                          "select=" +
                            i
                              .split(",")
                          ...
                          (this.queryParameters = c.format("select={0}", i));
                    }
        ...
        function(e, t, r) {
          !(function(e, t, i) {
            ...
            t.throwError = function(e) {
              if (e.errorCode === i.default[i.default.unknown]) throw e;
