...
import java.util.ArrayList;
 ...
 public class GrilleJeu {
    ...
    */
    ...
    /**
     * Test si pour une ile donner et une direction donner, un voisin existe
    ...
    public IleJoueur getVoisinDir(IleJoueur ile, String dir){
        ...
        if (dir.compareTo("N") == 0){
            for(i = ile.getX(),j=ile.getY(); j >= 0; j-- ){
                if (getIleGrilleSolution(i, j) != null && (i!=ile.getX() || j!= ile.getY())){
                    return (IleJoueur)getIleGrilleSolution(i, j);
                }
            }
